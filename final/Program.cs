...
// Кроме ручного ввода, предусмотрен тестовый режим с генерацией 
// случайных чисел.

// При запуске из консоли программа выводит приглашение с 
// описанием работы.
...
// Команда 4: задать параметры генерации массива случайных чисел и вывести 
// результат
// Команда 5: выйти из приложения
// Алгоритм функции фильтрации реализован при помощи промежуточного массива 
// (ведерка), который накапливает четные числа и сливает результат в общий
//  массив. При такой реализации, получается масштабируемый метод по 
//  потреблению памяти. Подобное поведение реализовано в стандартных 
//  коллекциях.
